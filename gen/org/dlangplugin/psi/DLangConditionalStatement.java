...
public interface DLangConditionalStatement extends DLangCompositeElement {
  ...
  @NotNull
  List<DLangCaseRangeStatement> getCaseRangeStatementList();

  @NotNull
  List<DLangCaseStatement> getCaseStatementList();
  ...
  @NotNull
  List<DLangDefaultStatement> getDefaultStatementList();
