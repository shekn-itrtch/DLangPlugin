...
public class DLangPragmaStatementImpl extends DLangCompositeElementImpl implements DLangPragmaStatement {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DLangVisitor) ((DLangVisitor)visitor).visitPragmaStatement(this);
  ...
  public DLangPragma getPragma() {
    return findNotNullChildByClass(DLangPragma.class);
  }
