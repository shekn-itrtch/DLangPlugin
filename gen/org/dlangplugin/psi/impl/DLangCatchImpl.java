...
public class DLangCatchImpl extends DLangCompositeElementImpl implements DLangCatch {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DLangVisitor) ((DLangVisitor)visitor).visitCatch(this);
